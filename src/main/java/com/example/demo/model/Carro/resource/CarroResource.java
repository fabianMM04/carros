...
public class CarroResource {
    ...
    @RequestMapping(value = "updateCarroById/{id}", method = RequestMethod.POST)
    public void updateCarroById(@PathVariable Long id, @Valid Carro carro) {
         carroService.actualizarCarro(id, carro);
    }
